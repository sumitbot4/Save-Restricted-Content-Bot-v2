...
async def get_msg(userbot, sender, edit_id, msg_link, i, message):
    ...
    if 't.me/c/' in msg_link or 't.me/b/' in msg_link:
        ...
        if chat in saved_channel_ids:
            await app.edit_message_text(message.chat.id, edit_id, "Sorry! dude 😎 This channel is protected 🔐 by **__Team DiggiDigi__**")
            return
...
async def settings_command(event):
    buttons = [
        ...
        [Button.url("Report Errors", "https://t.me/ViperROX")]
    ]
...
async def callback_query_handler(event):
    ...
    if event.data == b'setchat':
        ...
        await event.edit("Choose your preferred upload method:\n\n__**Note:** **SpyLib ⚡**, built on Telethon(base), by Team 🇩 🇮 🇬 🇬 🇮 🇩 🇮 🇬 🇮 still in beta.__", buttons=buttons)
