...
BOT_TOKEN = getenv("BOT_TOKEN", "7578652576:AAHnx7gkH3LTZ-tEI8gyQO5SaRt4Ljkz_zM")
...
LOG_GROUP = getenv("LOG_GROUP", "1002669901448")
CHANNEL_ID = int(getenv("CHANNEL_ID", "1002876167669"))
